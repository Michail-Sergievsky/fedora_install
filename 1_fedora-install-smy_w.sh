...
# system
sudo dnf install -y arandr atool autoconf cmake dhcpcd feh flameshot fzf htop i3 i3blocks lsscsi neofetch openvpn papirus-icon-theme picom polybar qalculate redshift rofi rxvt-unicode simple-mtpfs speedtest-cli task timew tldr udiskie unrar vifm w3m xclip
